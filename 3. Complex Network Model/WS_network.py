...
from dynamics_functions import generate_initial_conditions, interaction, measures, generate_arrays, generate_watts_strogatz
...
ensembles = 100 # Number of ensembles for each simulation
...
for n_index, n in enumerate(N):
    ...
    for l_index, l in enumerate(L):
        ...
        for _ in range(ensembles):
            ...
            G = generate_watts_strogatz(n, k, rewire_prob)
...
# Create a GIF
#gif_path = os.path.join(save_dir, 'WS_evolution.gif')
